...
namespace AcceptanceCutter {
  ...
  void set_x_range(double min, double max) { x_min_ = min; x_max_ = max; }
  void set_y_range(double min, double max) { y_min_ = min; y_max_ = max; }
  void set_eta_range(double min, double max) { eta_s_min_ = min; eta_s_max_ = max; }
  void set_pT_range(double min, double max) { pT_min_ = min; pT_max_ = max; }
  void set_yrap_range(double min, double max) { yrap_min_ = min; yrap_max_ = max; }
